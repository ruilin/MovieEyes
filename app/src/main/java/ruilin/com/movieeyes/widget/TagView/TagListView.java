 ...
 * 
 */
package ruilin.com.movieeyes.widget.TagView;
...
public class TagListView extends FlowLayout implements OnClickListener {
	...
	private void inflateTagView(final Tag t, boolean b) {
		...
		if (mTagViewTextColorResId <= 0) {
			int c = getResources().getColor(R.color.text_black);
	...
	public void addTags(List<? extends  Tag> lists) {
		addTags(lists, false);
	}

	public void addTags(List<? extends  Tag> lists, boolean b) {
