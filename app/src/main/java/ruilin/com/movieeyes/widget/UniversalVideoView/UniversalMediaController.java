...
package ruilin.com.movieeyes.widget.UniversalVideoView;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private void init(Context context) {
        ...
        if (mContext instanceof Activity) {
            viewRoot = ((Activity) context).getLayoutInflater() //LayoutInflater.from(context) //
                    .inflate(R.layout.uvv_player_controller, this);
        } else {
    ...
    private void initControllerView(View v) {
        ...
        loading = (ImageView) v.findViewById(R.id.popup_loading_iv_icon);
...
//        }
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.skin_uvv_player_player);
...
//            }
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.skin_uvv_stop);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.skin_uvv_player_player);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.player_screen_mode);
        } else {
            mScaleButton.setImageResource(R.drawable.player_screen_normal);
        }
    }
