...
//        if (!mSurfaceAvailable || mUri == null || mSurfaceHolder == null || havePrepare) {
...
//    };
//
//    private IjkMediaPlayer.OnCompletionListener mCompletionListener =
...
////                    LogUtil.w(TAG, "Error: " + framework_err + "," + impl_err);
//                    mCurrentState = STATE_ERROR;
//                    mTargetState = STATE_ERROR;
//                    if (mMediaController != null) {
...
////                LogUtil.w(TAG, "surfaceChanged!!!!     start();");
//
...
////            LogUtil.w(TAG, "surfaceDestroyed!!!!");
//
...
//            mMediaController.showLoading();
//        }
////        LogUtil.w(TAG, "START =========== current state = " + mCurrentState + " || isInPlaybackState = " + isInPlaybackState());
...
//    @Override
//    public void pause() {
////        LogUtil.w(TAG, "PAUSE =========== current state = " + mCurrentState);
//        if (isInPlaybackState()) {
//            if (mMediaPlayer.isPlaying()) {
//                mMediaPlayer.pause();
